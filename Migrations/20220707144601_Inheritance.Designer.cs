...
namespace Lab5AspNetCoreEfIndividual.Migrations
{
    ...
    [Migration("20220707144601_Inheritance")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lab5AspNetCoreEfIndividual.Models.Person", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Lab5AspNetCoreEfIndividual.Models.Doctor", b =>
                {
                    b.HasBaseType("Lab5AspNetCoreEfIndividual.Models.Person");
            ...
            modelBuilder.Entity("Lab5AspNetCoreEfIndividual.Models.Doctor", b =>
                {
                    b.HasOne("Lab5AspNetCoreEfIndividual.Models.Person", null)
                        .WithOne()
                        .HasForeignKey("Lab5AspNetCoreEfIndividual.Models.Doctor", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Lab5AspNetCoreEfIndividual.Models.Patient", b =>
                {
                    b.HasOne("Lab5AspNetCoreEfIndividual.Models.Person", null)
                        .WithOne()
                        .HasForeignKey("Lab5AspNetCoreEfIndividual.Models.Patient", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
