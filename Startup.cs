...
namespace Lab5AspNetCoreEfIndividual
{
    public class Startup
    {
        ...
        {
            // Register HospitalContext as a service
            // For local development, system reads the connection string from the appsettings.json file
            // EF creates an empty database.
            // the Dispose method will be called automatically at the end of the web request.
